...
export default function Terms() {
  useSEO({
    ...
    description: "Mandi terms of service.",
    path: "/legal/terms",
  });
  return (
    <div className="flex flex-col w-full pb-24 px-4 pt-16">
      <div className="container mx-auto max-w-3xl bg-white p-8 md:p-12 rounded-2xl border border-border/50 shadow-sm prose prose-slate">
        ...
        <p>These Terms of Service ("Terms") govern your access to and use of the Mandi website. By accessing or using our website, you agree to be bound by these Terms.</p>
        ...
        <p>The website and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by Mandi LLC, its licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>
        ...
        <p>In no event will Mandi LLC, its affiliates, or their licensors, service providers, employees, agents, officers, or directors be liable for damages of any kind, under any legal theory, arising out of or in connection with your use, or inability to use, the website.</p>
        ...
        <h2>6. Contact Us</h2>
        <p>If you have any questions about these Terms, please contact us at <a href="mailto:hello@heymandi.ai">hello@heymandi.ai</a>.</p>
      </div>
    </div>
  );
}
