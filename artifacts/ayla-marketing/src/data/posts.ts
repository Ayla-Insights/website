  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        type: "p",
        content:
          "The front desk coordinator who starts their morning knowing exactly which three patients to call, why each one is likely to say yes, and what to say when they pick up is operating at a completely different level than one who has to reconstruct that context from three separate reports.",
      },
      {
        type: "p",
        content:
